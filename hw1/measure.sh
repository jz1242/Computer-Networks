...
h1 ./iPerfer -s -p 2000 | tail -n 1 > ./measurements/throughput_L1.txt &
h3 ./iPerfer -c -h 10.0.0.1 -p 2000 -t 20 | tail -n 1 >> ./measurements/throughput_L1.txt
h3 echo "\h3, \h4 - Testing throughput of links with ./iPerfer..."
h3 ./iPerfer -s -p 2001 | tail -n 1 > ./measurements/throughput_L2.txt &
h4 ./iPerfer -c -h 10.0.0.3  -p 2001 -t 20 | tail -n 1 >> ./measurements/throughput_L2.txt
h3 echo "\h3, \h7 - Testing throughput of links with ./iPerfer..."
h3 ./iPerfer -s -p 2002 | tail -n 1 > ./measurements/throughput_L3.txt &
h7 ./iPerfer -c  -h 10.0.0.3 -p 2002 -t 20| tail -n 1 >> ./measurements/throughput_L3.txt
h4 echo "\h4, \h8 - Testing throughput of links with ./iPerfer..."
h4 ./iPerfer -s -p 2003 | tail -n 1 > ./measurements/throughput_L4.txt &
h8 ./iPerfer -c -h 10.0.0.4 -p 2003 -t 20 | tail -n 1 >> ./measurements/throughput_L4.txt
h8 echo "\h8, \h9 - Testing throughput of links with ./iPerfer..."
h8 ./iPerfer -s -p 2004 | tail -n 1 > ./measurements/throughput_L5.txt &
h9 ./iPerfer -c -h 10.0.0.8 -p 2004 -t 20 | tail -n 1 >> ./measurements/throughput_L5.txt
...
h1 ./iPerfer -s -p 2005 | tail -n 1 > ./measurements/throughput_Q2.txt &
h10 ./iPerfer -c -h 10.0.0.1 -p 2005 -t 20 | tail -n 1 >> ./measurements/throughput_Q2.txt
...
h1 ./iPerfer -s -p 2006 &
h2 ./iPerfer -s -p 2007 | tail -n 1 > ./measurements/throughput_Q3_1.txt &
h6 ./iPerfer -c -h 10.0.0.1 -p 2006 -t 20  &
h9 ./iPerfer -c -h 10.0.0.2 -p 2007 -t 20  | tail -n 1 >> ./measurements/throughput_Q3_1.txt 
...
h1 ./iPerfer -s -p 2008 &
h2 ./iPerfer -s -p 2009 &
h5 ./iPerfer -s -p 2010 | tail -n 1 > ./measurements/throughput_Q3_2.txt &
h6 ./iPerfer -c -h 10.0.0.1 -p 2008 -t 20 &
h9 ./iPerfer -c -h 10.0.0.2 -p 2009 -t 20 &
h10 ./iPerfer -h 10.0.0.5 -c -p 2010 -t 20 | tail -n 1 >> ./measurements/throughput_Q3_2.txt 
...
h1 ./iPerfer -s -p 2011 | tail -n 1 > ./measurements/throughput_h1-h10.txt &
h3 ./iPerfer -s -p 2012 | tail -n 1 > ./measurements/throughput_h3-h8.txt &
h8 ./iPerfer -c -h 10.0.0.3 -p 2012 -t 20  | tail -n 1 >> ./measurements/throughput_h3-h8.txt &
h10 ./iPerfer -c -h 10.0.0.1 -p 2011 -t 20  | tail -n 1 >> ./measurements/throughput_h1-h10.txt 
